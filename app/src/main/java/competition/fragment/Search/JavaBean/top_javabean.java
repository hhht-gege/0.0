...
public class top_javabean {


    /**
     * code : 0
     * msg :
     * data : {"dynamics":[{"dynamicId":0,"topic":"","publishTime":"","content":"","picturesUrl":[{"pictureUrl":""}],"publisher":{"userId":0,"username":"","userPortraitPath":""}}],"history_offset":0}
     */
    ...
    public static class DataBean {
        /**
         * dynamics : [{"dynamicId":0,"topic":"","publishTime":"","content":"","picturesUrl":[{"pictureUrl":""}],"publisher":{"userId":0,"username":"","userPortraitPath":""}}]
         * history_offset : 0
         */

        private List<DynamicsBean> dynamics;
        private int history_offset;
        ...
        public int getHistory_offset() {
            return history_offset;
        }

        public void setHistory_offset(int history_offset) {
