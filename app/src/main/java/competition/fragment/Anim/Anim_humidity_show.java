...
public class Anim_humidity_show extends AppCompatActivity implements View.OnClickListener {
    private static String TAG = "Anim_humidity_show";
                ...
                task.enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(Anim_humidity_show.this, "服务器异常。。。", Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        if (body.getData().getCollarMsgs().size() == 0) {
                            Toast.makeText(Anim_humidity_show.this, day + "没有历史记录", Toast.LENGTH_SHORT).show();
                        }
                        InitZhexian();
                    } else {
                        Toast.makeText(Anim_humidity_show.this, body.getMsg(), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    Toast.makeText(Anim_humidity_show.this, "服务器异常，请稍候再试", Toast.LENGTH_SHORT).show();
                }
            }
