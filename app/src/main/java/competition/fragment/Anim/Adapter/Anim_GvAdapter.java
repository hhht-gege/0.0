...
public class Anim_GvAdapter extends BaseAdapter {
    private Context context;
    private int mMaxPosition;//根据这个list.size+1 来进行判断
    private List<String> list;

    public  Anim_GvAdapter(Context context, List<String> list) {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        Anim_GvAdapter.ViewHolder vh=null;
        if (v==null){
            vh=new Anim_GvAdapter.ViewHolder();
            ...
            vh= (Anim_GvAdapter.ViewHolder) v.getTag();
        }
