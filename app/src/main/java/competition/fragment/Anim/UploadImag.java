...
public class UploadImag {
    ...
    private static final String TAG = "UploadImag";

    public Call<ResponseBody> uploadImag(String path, int petId, String token){
        ...
        return api.upload_imag(part,petId,token);
    }
